...
//Endpoint para otener el score del cliente y con el número decidir si dar el valor fizz, buzz, fizzbuzz o regresar el mismo score
app.get('/v1/fizzbuzz/:score',(request, response)=>{

    const score = request.params.score; //Obtenemos el score que manda el cliente

    const valorResultante = ExplorerController.getValidationScore(score);

    response.json({
        score: request.params.score,
        trick: valorResultante
    })
})